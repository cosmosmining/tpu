...
| 2026-06-08 | 3fc2f0f | 7 | 100% (26/26) | 1,000,288 | **OpenLane synth 165,413 µm²** (run #4); yosys-abc 124k | Fmax: CI | **64.6% of 8×2** (6×2 was 86%→congested) | n/a | Die 6×2→8×2: real OpenLane area 33% > yosys-abc; 6×2 routing-congested (run #4), 8×2 fits ≤70%. Run #5 hardening. |
